...
/* harmony import */ var _utils_scroll_to_block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/scroll-to-block */ "./js/utils/scroll-to-block.js");
/* harmony import */ var _utils_menu_toggle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/menu-toggle */ "./js/utils/menu-toggle.js");
/* harmony import */ var _utils_checkbox_checked__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/checkbox-checked */ "./js/utils/checkbox-checked.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_checkbox_checked__WEBPACK_IMPORTED_MODULE_4__["checkboxChecked"])();
  Object(_utils_menu_toggle__WEBPACK_IMPORTED_MODULE_3__["menuToggle"])();
  Object(_utils_scroll_to_block__WEBPACK_IMPORTED_MODULE_2__["scrollToBlock"])();
  // Modules
  // ---------------------------------
...
/***/ "./js/utils/checkbox-checked.js":
/*!**************************************!*\
  !*** ./js/utils/checkbox-checked.js ***!
  \**************************************/
/*! exports provided: checkboxChecked */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkboxChecked", function() { return checkboxChecked; });
var checkboxChecked = function checkboxChecked() {
  var button = document.querySelector('.form__button');
  var messageError = document.querySelector('.form__checkbox-error');
...
var menuToggle = function menuToggle() {
  ...
  var logo = document.querySelector('[data-logo-link]');
  ...
  var overlayHandler = function overlayHandler() {
    closeMenu();
  };
...
var scrollToBlock = function scrollToBlock() {
  var scrollToAdvantages = function scrollToAdvantages() {
    var scrollButton = document.querySelector('[data-scroll-advantages]');
    var block = document.querySelector('[data-advantages]');
  ...
  var scrollToBooking = function scrollToBooking() {
    var scrollButton = document.querySelector('[data-scroll-booking]');
    var block = document.querySelector('[data-booking]');
    scrollButton.addEventListener('click', function (e) {
      e.preventDefault();
      block.scrollIntoView({
        block: 'center',
  ...
  var scrollToProducts = function scrollToProducts() {
    var scrollButton = document.querySelector('[data-scroll-products]');
    var block = document.querySelector('[data-products]');
    scrollButton.addEventListener('click', function (e) {
      e.preventDefault();
      block.scrollIntoView({
        block: 'center',
  ...
  var scrollToLocation = function scrollToLocation() {
    var scrollButton = document.querySelector('[data-scroll-location]');
